...
public class LogAspects {
    ...
    /**
     * @Before 在目标方法之前切入，切入点表达式(指定哪个方法切入)
     */
    ...
    public void logEnd(JoinPoint joinPoint) {
        System.out.println("" + joinPoint.getSignature().getName() + "除法结束....."+joinPoint.getTarget());
    }

    @AfterReturning(value = "pointCut()", returning = "object")
    public void logReturn(JoinPoint joinPoint, Object object) {
        System.out.println("" + joinPoint.getSignature().getName() + "除法正常返回.... 运行结果:{" + object + "}");
    }
